...
export default function Home() {
  ...
  return (
    <>
      ...
      <header className="container mx-auto max-w-6xl block">
      ...
      <section className="hero flex justify-between py-6 my-12 md:max-w-6xl mx-auto">
        <motion.div
        ...
        >
          <h1
            className='lg:text-6xl md:text-5xl font-["Cardo"] font-bold text-[#232323]'
          >
            Travel to your dream destination
          </h1>
          <p className='font-["Lato"] py-6 text-[#232323] md:text-[.8em] lg:text-[1em]'>
